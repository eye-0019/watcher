module.exports = {
    ...
    roles: {
        create: process.env.ROLE_LOG_CHANNEL,
        delete: process.env.ROLE_LOG_CHANNEL
    },


    channels: {
        create: process.env.CHANNEL_LOG_CHANNEL,
        delete: process.env.CHANNEL_LOG_CHANNEL
    },


    invites: {
        create: process.env.INVITE_LOG_CHANNEL
    },
    ...
    system: process.env.ERROR_LOG_CHANNEL
};
