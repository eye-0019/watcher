    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(
                `─────────────────────────────\n\n` +
                `⌕ **don't be a loser**\n` +
                `> jokes and arguing are fine. harassing, bullying, or targeting someone isn't... only sometimes tho\n\n` +
                `⌕ **respect boundaries**\n` +
                `> if someone tells you to stop, stop. no means no, you horny freak.\n\n` +
                `⌕ **keep it legal**\n` +
                `> no illegal content or encouraging illegal activity. if you're 18 please don't talk to a 15 year old weirdo.\n\n` +
                `⌕ **for nsfw**\n` +
                `> nsfw is okay just don't be a loser and ask people for stuff. trust me, people will get horny with u in dms if they wanted to.\n\n` +
                `⌕ **no doxxing**\n` +
